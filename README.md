...
storytoy-cli/0.2.1 linux-x64 node-v16.3.0
...
_See code: [src/commands/config.ts](https://github.com/benrosen/storytoy-cli/blob/v0.2.1/src/commands/config.ts)_
...
_See code: [src/commands/create.ts](https://github.com/benrosen/storytoy-cli/blob/v0.2.1/src/commands/create.ts)_
...
_See code: [src/commands/delete.ts](https://github.com/benrosen/storytoy-cli/blob/v0.2.1/src/commands/delete.ts)_
...
_See code: [src/commands/read.ts](https://github.com/benrosen/storytoy-cli/blob/v0.2.1/src/commands/read.ts)_
...
_See code: [src/commands/update.ts](https://github.com/benrosen/storytoy-cli/blob/v0.2.1/src/commands/update.ts)_
<!-- commandsstop -->
